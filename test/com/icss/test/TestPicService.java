...
public class TestPicService {
	...
	public void testInsert() throws IOException{
		...
		Pic pic = new Pic(file.getName(), "lalal", file.length(), "tom",picData ,new Date());
	...
	public void testQueryById() throws IOException {
		...
		Pic pic = service.queryPicById(168);
		
		File file = new File("e:\\ͼƬ168ewac.jpg");
