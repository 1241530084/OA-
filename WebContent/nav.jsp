		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="list-group">
								...
								<div class="panel">
									...
									<div id="one" class="panel-collapse collapse">
										<div class="panel-body">
											<a href="weather.html" target="content">天气查询</a>
					...
					<shiro:hasAnyRoles name="searchAdmin">
					<a href="SearchEmp.html" class="list-group-item" target="content">
						<span class="glyphicon glyphicon-search"></span>
						数据检索
					</a>
					</shiro:hasAnyRoles>
					<shiro:hasAnyRoles name="picAdmin">
					<a href="QueryPic.html" class="list-group-item" target="content">
						<span class="glyphicon glyphicon-picture"></span>
						公司图库
					</a>
					</shiro:hasAnyRoles>
					<a href="<%=request.getContextPath()%>/logout" target="_top" class="list-group-item" >
